...
import { getDBConnection, getCategories, getAccounts } from '../../services/db-services';


function TransactionDetail(props: TransactionDetailProp) {
    const { navigation, route } = props;

    const [transaction, setTransaction] = React.useState<Transaction>(route.params.transaction);
                    ...
                    <View>
                        ...
                        <View style={{ backgroundColor: 'white' }}>
                            <View style={[styles.buttonContainer, {}]}>
                                ...
                                <TouchableOpacity onPress={() => {setTransaction({ ...transaction, type: 'expense' });}}>
                            ...
                            {showDTP && (
                                <DateTimePicker
                                    ...
                                    onChange={(event, selectedDate) => {
                                        ...
                                        setShowDTP(false);
                                        if (selectedDate) {
                                            setTransaction({ ...transaction, day: selectedDate.getDate(), month: selectedDate.getMonth() + 1, year: selectedDate.getFullYear() });
                                        }
                                    }}
                                />
                            )}
                        ...
                        <View style={styles.bottomContainer}>
                            ...
                            <View style={{ flexDirection: 'row', padding: "4%", marginTop: "1%" }}>
                                ...
                                <TouchableOpacity 
                                    ...
                                    onPress={() => {setTransaction({ ...transaction, amount: 0, note: '' });}}>
