...
function DayBox(props: { dayBoxModel: DayBoxModel, navigation: any, currency: Currency, showFooter: Boolean }) {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View
        style={[styles.header, {backgroundColor: theme.componentBackground}]}>
        <View style={{flexDirection: 'row', justifyContent: 'flex-start'}}>
          ...
          <View style={styles.monthYear}>
            ...
            <Text style={[styles.month, {color: theme.color}]}>
              {props.dayBoxModel.month}/{props.dayBoxModel.year}
            </Text>
          </View>
        </View>
        <View style={styles.inContainer}>
          <Text
            style={[
              ...
              {
                fontSize:
                  props.dayBoxModel.totalIncome.toString().length > 8 ? 14 : 19,
              },
            ]}>
            {props.currency.symbol} {props.dayBoxModel.totalIncome}
          </Text>
        </View>
        <View style={styles.outContainer}>
          <Text
            style={[
              ...
              {
                fontSize:
                  props.dayBoxModel.totalExpense.toString().length > 8
                    ? 14
                    : 19,
              },
            ]}>
            {props.currency.symbol} {props.dayBoxModel.totalExpense}
          </Text>
        </View>
      </View>
